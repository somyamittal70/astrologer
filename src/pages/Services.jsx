    ...
    <>
      <style>{`
        ...
        .svc-row {
          ...
          box-shadow: 0 8px 40px rgba(45,0,79,0.06);
          background: #fff;
        ...
        @media (max-width: 900px) {
          ...
          .svc-img-pane { min-height: 260px; }
          .svc-content-pane { padding: 36px 30px; }
        }
        @media (max-width: 500px) {
          .svc-content-pane { padding: 28px 22px; }
          .svc-section { padding: 70px 18px !important; }
        }
      `}</style>
